...
public class CookieUtils {
   ...
   //private final static String DES_KEY = DesUtils.initSecretKey(56);
    ...
    public static void writeCookieToken(HttpServletResponse response,
                                   String cookieName, String cookieValue) {
        Cookie breakupCookie = new Cookie(cookieName, cookieValue);
        breakupCookie.setPath("/");
    ...
    public static void invalidate(HttpServletRequest request,
        ...
        if(cookies!=null) {
            for (int i = 0; i < cookies.length; i++) {
                ...
                if (cookies[i].getName()!="account"&&!cookies[i].getName().equals("account")) {
