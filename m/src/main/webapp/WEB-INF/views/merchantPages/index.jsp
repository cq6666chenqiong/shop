...
<div class="content clearfix" id="content">
    <iframe src="${path}/merchant/index/home" scrolling="no" id="UFrame"></iframe>
</div>
<!-- 内容 end -->
...
<script type="text/javascript">
    $(function (){
        ...
        $('.header_center li a').on('click',function (){
            ...
            if( _thatindex == 0 ){
                $('.content').html('<iframe src="${path}/merchant/index/home" scrolling="no" id="UFrame"></iframe>');
            }else{
    ...
    function loadMenu() {
        $.ajax({
            url: "${path}/merchant/channelInfo/loadMenu",
            global: false,
            type: "GET",
            dataType: "json",
            async: false,
