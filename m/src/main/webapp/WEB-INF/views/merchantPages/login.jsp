        ...
        <div class="my">
        	<div class="my-container">
			  ...
			  <div class="login2">
				  ...
				  <img src="${path}/merchant/index/imageCode" width="110px" height="40px" border="0"
					   onclick="this.src='${path}/merchant/index/imageCode?'+Math.random()" class="login2_4"/>
			  </div>
				<div class="wrong"></div>
			  <div class="login3">
        ...
        $("#account").focus();
            ...
            function checkForSubmit(){
                ...
                jQuery.ajax({type: "post",
                    url:  "${path}/merchant/index/authenticate",
                    data: {
                        "account":account,
                        "password":password,
                        "imagecode":imagecode
                    ...
                    success: function(result){
                        if (result.success) {
                            ...
                            window.location.href="${path}/merchant/index";
                        } else {
