    ...
    <script type="text/javascript">
        ...
        $(function(){
            $("#resourceTreeTable").loadTreeTable({
                url:'/merchant/channelInfo/getChannelTreeWithRoleId?roleId=' +"${roleInfo.id}",
                checkBox:true,
                expandable: true
            ...
            $("#inputForm").validate({
                ...
                submitHandler: function(form) {
                    $.ajax({
                        url: "${path}/merchant/roleInfo/update",
                        global: false,
                        type: "POST",
                        dataType: "json",
                        data:{
	...
	<div class="right">
		...
		<div>
			<div class="role_append" style="display: block;">
                <form id="inputForm" action="${path}/merchant/roleInfo/update" method="post">
					<input type="hidden" name="id" id="roleId" value="${roleInfo.id}">
					<div class="role_top1">
					<h2>角色管理 > 编辑角色</h2>
					<p>基础设置</p>
				</div>
				...
				<input type="hidden" name="resourceIds" id="resourceIds" value="${roleInfo.resourceIds}">
